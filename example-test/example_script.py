...
#See if LRS is accessible
#print("asking the remote LRS...")
#asked_lrs = lrs.about()
#if not asked_lrs.success:
#    raise ValueError("Failed to connect to server : "+str(asked_lrs.response.status))
...
if LOCAL_ONLY:
    print("LOCAL_ONLY is set to true ; I'm not trying to send info to an LRS...")
    print("Here is the resulting statement : ")
